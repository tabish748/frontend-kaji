...
export const CUSTOMER_PUBLIC_ROUTES = ["/cn-login", "/cn-contact-form", "/cn-info","/cn-info-child", "/cn-order-acceptance", "/cn-forgot-password","/cn-reset-password", "/sign-up", "/404", "/unauthenticated"];
...
export const ADMIN_ROUTES = [
  "/",
  "/inquiry/create",
  "/inquiry/create/basic-info-1",
  "/inquiry/create/basic-info-2",
  "/inquiry/create/contract",
  "/inquiry/create/quotation",
  "/inquiry/create/invoice",
  "/inquiry/create/history",
  "/settings",
  "/projectLegal",
  "/projectConfirmed",
  "/legalDashboard",
