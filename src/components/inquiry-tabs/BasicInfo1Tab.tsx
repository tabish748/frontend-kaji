...
import {
  ...
  resetCreateCustomerBasicInfo,
} from "../../app/customer/createCustomerBasicInfoSlice";
...
const BasicInfo1Tab: React.FC = () => {
  ...
  const createCustomerState =
    useSelector((state: RootState) => state.createCustomerBasicInfo) || {};
